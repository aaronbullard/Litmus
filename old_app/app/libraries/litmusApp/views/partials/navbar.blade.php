...
<div class="navbar navbar-fixed-top">
   <div class="navbar-inner">
     <div class="container">
       ...
       <a class="brand" href="{{ URL::to('litmus/users') }}">{{Config::get('litmus::config.app_name')}}</a>
       <div class="nav-collapse collapse" id="main-menu">
        ...
        <ul class="nav" id="main-menu-left">
		 ...
		 <li class="dropdown">
		  ...
		  <li class="dropdown">
            <a class="dropdown-toggle" data-toggle="dropdown" href="{{ URL::to('litmus') }}">Litmus <b class="caret"></b></a>
            <ul class="dropdown-menu" id="swatch-menu">
