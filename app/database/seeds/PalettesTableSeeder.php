...
class PalettesTableSeeder extends Seeder {
	...
	public function run()
	{
		...
		DB::unprepared(
				"INSERT INTO `palettes` (`id`, `title`, `description`, `account_id`, `created_at`, `updated_at`) VALUES
				...
				(4, 'Colormatch''s Control Palette', 'Collection of colors used for control management.', 1, '2013-08-15 00:53:24', '2013-08-15 00:53:24');"
			);
	}
